            ...
            <table>
              ...
              <tr>
                ...
                <div class="d-flex">
                  ...
                  <input class="btn myBtn-gold mt-5" style="margin-left:370px" type="submit" value="送出">
                </div>
              </tr>
          ...
          <form method="post" action="../api/back_users_update.php" style="margin-left:95px">
            ...
            <table>
              ...
              <tr>
                ...
                <div class="d-flex">
                <input type="hidden" name="admin" value="admin">
                  <input class="btn myBtn mt-5" style="margin-left:1225px" type="submit" value="送出">
                </div>
                <hr>
              </tr>
